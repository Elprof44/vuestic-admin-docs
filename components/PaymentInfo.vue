<template>
        ...
        <div class="flex items-center justify-between md:justify-items-stretch">
          <div
            ...
            <div class="md:w-48">
              ...
              <p class="font-bold capitalize">T-money</p>
            </div>
          </div>
          <div class="md:w-48 flex justify-end">
            <VaButton preset="primary">Payment preferences</VaButton>
          </div>
        </div>
      </template>
    </VaCardContent>
  ...
  <ChangeYourPaymentPlan v-if="isChangeYourPaymentPlanModalOpen" :yearly-plan="paymentPlan.isYearly"
    @confirm="updatePaymentPlan" @cancel="togglePaymentPlanModal" />
</template>
