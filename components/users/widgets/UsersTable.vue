...
<template>
  <VaDataTable sort-by="Full Name" sorting-order="asc" :columns="columns" :items="users" :loading="$props.loading">
    <template #cell(fullname)="{ rowData }">
      <div class="flex items-center justify-center gap-2 max-w-[230px] ellipsis">
